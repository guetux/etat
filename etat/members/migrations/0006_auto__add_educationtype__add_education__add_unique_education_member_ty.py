...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Role.department'
        db.alter_column(u'members_role', 'department_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['departments.Department']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Role.department'
        db.alter_column(u'members_role', 'department_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['departments.Department']))
