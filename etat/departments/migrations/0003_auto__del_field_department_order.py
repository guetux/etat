...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Department.order'
        db.delete_column(u'departments_department', 'order')


    def backwards(self, orm):
        # Adding field 'Department.order'
        db.add_column(u'departments_department', 'order',
